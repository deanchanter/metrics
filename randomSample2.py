...
'''
getTasks returns a dataFrame of fished tasks with start and end days and a
...
def getTasks(days, wip_limit, seed = None):
    if seed != None :
        np.random.seed(seed)
...
# this can be a funciton that returns 'finished_tasks'
    ...
    return finished_tasks_df, not_finished_task_df
